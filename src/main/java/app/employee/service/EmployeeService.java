...
public class EmployeeService {
    ...
    public void deleteEmployeeById(UUID id) {
        try {
            ...
            log.error("Unable to call notification-svc to delete employee.");
            throw new EmployeeFeignException("Employee service is temporary down!Please try again later!");
        }
    }
}
